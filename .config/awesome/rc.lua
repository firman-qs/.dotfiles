...
globalkeys = gears.table.join(
   ...
   awful.key({ modkey, "Shift" }, "F5", awesome.restart, { description = "Reload awesome", group = "Awesome" }),
   awful.key({ modkey }, "s", function()
      awful.spawn.with_shell("flameshot gui")
   end, { description = "Flameshot GUI Screenshot", group = "Apps" }),
   ...
   awful.key({ modkey }, "d", function()
      awful.util.spawn("dm_run.py")
   end, { description = "Run launcher", group = "Dmenu" }),
   ...
   awful.key({ modkey }, "p", function()
      ...
      grabber = awful.keygrabber.run(function(_, key, event)
         ...
         elseif key == "x" then
            awful.spawn.with_shell("dm-logout")
         elseif key == "p" then
            awful.spawn.with_shell("gpick -s")
         elseif key == "h" then
         ...
         elseif key == "s" then
            awful.spawn.with_shell("dm-record")
         elseif key == "c" then
            awful.spawn.with_shell("dm-confedit")
         elseif key == "f" then
            awful.spawn.with_shell("dm-websearch")
         elseif key == "w" then
            awful.spawn.with_shell("dm-weather")
         elseif key == "n" then
            awful.spawn.with_shell("dm-wifi")
         end
         awful.keygrabber.stop(grabber)
      end)
   end, { description = "followed by [b, x, p, h, m, o, r, s, c, w, f, n]", group = "Dmenu" }),
   -- }}}
   ...
   end, { description = "followed by [n]etwork, [a]udio, [b]ackground", group = "System Settings" }),

   -- Brightness control
   awful.key({}, "XF86MonBrightnessUp", function()
      awful.spawn.with_shell("brightnesscontrol.sh i")
   end, { description = "Brightness +5%", group = "System Control" }),
   awful.key({}, "XF86MonBrightnessDown", function()
      awful.spawn.with_shell("brightnesscontrol.sh d")
   end, { description = "Brightness -5%", group = "System Control" }),
   ...
   end, { description = "Volume +5%", group = "System Control" }),
   ...
   awful.key({}, "XF86AudioMute", function()
      ...
      -- beautiful.volume.update()
   end, { description = "Mute/unmute", group = "System Control" }),
   -- }}}
   ...
   end, { description = "followed by VS[c]ode, [e]macs, [a, b, d], [m]ousepad", group = "Editor" }),
   -- }}}
   ...
   awful.key({ modkey }, "Left", awful.tag.viewprev, { description = "view previous all", group = "Tag" }),
   awful.key({ modkey }, "Right", awful.tag.viewnext, { description = "view next all", group = "Tag" }),
